    ...
    <div className="px-3 py-12 md:px-0 md:py-16">
      <div className="grid grid-cols-1 gap-10 text-center md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 max-w-[220px] text-sm leading-relaxed text-white/70">
            Thoughtful gifting, powered by AI.
          </p>
        </div>
          ...
          <ul className="mt-4 space-y-3">
            {quickLinks.map((l) => (
              <li key={l.label}>
                <Link
                  href={l.href}
                  className="text-sm text-white/70 transition-colors hover:text-pink-400"
                >
                  {l.label}
                </Link>
              </li>
