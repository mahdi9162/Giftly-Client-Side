          ...
          <div className="relative p-4 sm:p-6 lg:p-10">
            ...
            <div className="w-full min-w-0">
              ...
              <p className="mt-4 max-w-xl text-sm leading-relaxed text-slate-500 md:text-base md:leading-7">
                Our AI-powered gift finder takes the guesswork out of gifting. Answer a few simple questions and get personalized
                      ...
                      >
                        <div className="flex flex-col gap-3">
                          <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${step.iconBg}`}>
                            <Icon className={`h-5 w-5 ${step.iconColor}`} strokeWidth={2} />
                          </div>
              ...
              <div className="w-full min-w-0 flex-1 xl:max-w-[520px]">
                <div className="mx-auto w-full max-w-full rounded-3xl border border-slate-200/70 bg-white p-4 shadow-[0_15px_40px_-12px_rgba(15,23,42,0.08)] sm:p-6">
                  ...
                  <p className="mb-5 text-xs leading-relaxed text-slate-400">
                    Example recommendation flow — try the real thing on the AI page.
                  </p>

                  <div className="space-y-4">
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-slate-700">Who is this gift for?</label>
                    ...
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-slate-700">What&apos;s the occasion?</label>
                      <div className="flex w-full items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                        <span>Birthday</span>
                        <ChevronDown className="h-4 w-4 shrink-0 text-slate-400" />
                      </div>
                    ...
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-slate-700">What&apos;s your budget?</label>
                      <div className="flex w-full items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                        <span>$10 - $30</span>
                        <ChevronDown className="h-4 w-4 shrink-0 text-slate-400" />
                      </div>
                  ...
                  <div className="mt-6 border-t border-slate-100 pt-5">
                    ...
                    <div className="space-y-3">
                      {mockResults.map((item) => (
                        <div key={item.id} className="flex w-full items-center gap-3 rounded-xl border border-slate-100 bg-slate-50 p-3">
                          <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-lg">
                            <Image src={item.image} alt={item.name} fill sizes="56" className="object-cover" />
                          </div>
