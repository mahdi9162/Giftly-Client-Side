import { LayoutDashboard, ShoppingBag, User, Settings, Package, Users, BarChart3 } from 'lucide-react';
...
export const adminRoutes = [
  ...
  { label: 'Page Settings', href: '/dashboard/admin/settings', icon: Settings },
];
